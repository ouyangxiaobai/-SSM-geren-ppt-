...
//        return Base64.decode(hexStr);
    ...
    public static final String keyBytes = "d3t6p9jkb%3#n890";
    public static final String keyBytesOut = "a4t6p8lpb%5#x215";
    ...
    public static String encode(String content) {
        ...
        return Base64.encode(encrypt(content, keyBytes));
//        return parseByte2HexStr(encrypt(content, keyBytes));
    ...
    public static String decode(String content) {
        content="uOe3ICSDcGCqHD85rN8IOjxB9bdFDFlYA4dlb%2FlZH8iTWIpYoBjjoVDa7b6705WJWGjrZ6tT3F9OReWhV7vGv1Z8QTVdorrcxMjpYBhHvEcXzHgRGm7mvBjbCyS1d1n30m6IR1n7u%2F6JV4hjNLmEchHV4UIt0LFMkGsHwZTQ9SqJpRCPLuuZfFfQjTHGxd30cK6eiH0fwIK3upk9qtpYYfxs5DOETo7Tes1OA%2FotXjI4horhNGRTSD8KfK4QuX%2Bz";

        //解密之前,先将输入的字符串按照16进制转成二进制的字节数组,作为待解密的内容输入
        byte[] b = decrypt(Base64.decode(content), keyBytesOut);
        System.out.println(new String(b));
        return new String(b);
    }

    public static void main(String[] args) {
        String content="uOe3ICSDcGCqHD85rN8IOjxB9bdFDFlYA4dlb%2FlZH8iTWIpYoBjjoVDa7b6705WJWGjrZ6tT3F9OReWhV7vGv1Z8QTVdorrcxMjpYBhHvEcXzHgRGm7mvBjbCyS1d1n30m6IR1n7u%2F6JV4hjNLmEchHV4UIt0LFMkGsHwZTQ9SqJpRCPLuuZfFfQjTHGxd30cK6eiH0fwIK3upk9qtpYYfxs5DOETo7Tes1OA%2FotXjI4horhNGRTSD8KfK4QuX%2Bz";
    ...
    public static String decode(String content, String key) {
        byte[] b = decrypt(Base64.decode(content), key);
        return new String(b);
    }
}