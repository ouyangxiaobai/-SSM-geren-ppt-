...
public class YuyueguahaoController {
    ...
    public R add(@RequestBody YuyueguahaoEntity yuyueguahao, HttpServletRequest request){
		...
		wrapper.eq("yishenggonghao", yuyueguahao.getYishenggonghao());
		List<ChuzhenxinxiEntity> list= chuzhenxinxiService.selectList(wrapper);

		ChuzhenxinxiEntity chuzhenxinxiEntity=list.get(0);
		Integer hum=chuzhenxinxiEntity.getKeyuerenshu()-1;
		chuzhenxinxiEntity.setKeyuerenshu(hum);
		chuzhenxinxiService.updateById(chuzhenxinxiEntity);
