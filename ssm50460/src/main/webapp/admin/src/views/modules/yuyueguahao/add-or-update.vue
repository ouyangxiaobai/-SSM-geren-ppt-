    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="时间段" prop="shijianduan">
          <el-select v-model="ruleForm.shijianduan" placeholder="请选择时间段">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="就诊描述" prop="jiuzhenmiaoshu">
          <el-input v-model="ruleForm.jiuzhenmiaoshu" 
              placeholder="就诊描述" clearable  :readonly="ro.jiuzhenmiaoshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="就诊描述" prop="jiuzhenmiaoshu">
              <el-input v-model="ruleForm.jiuzhenmiaoshu" 
                placeholder="就诊描述" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
