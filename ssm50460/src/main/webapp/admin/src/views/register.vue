  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">个人健康服务预约系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shanzhang" class="input" type="text" placeholder="擅长">
			   </div>
			 </div> -->
			<el-form-item label="擅长" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.shanzhang" autocomplete="off" placeholder="擅长" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://up.desktx.net/pic/3a/47/bf/3a47bfc3df53db66af73093a345f0cfd.jpg");
		height: 100vh;
