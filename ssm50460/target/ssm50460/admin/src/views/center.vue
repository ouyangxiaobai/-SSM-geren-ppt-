  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yisheng'"  label="擅长" prop="shanzhang">
          <el-input v-model="ruleForm.shanzhang"               placeholder="擅长" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  mounted() {
    ...
    this.yishengzhichengOptions = "医师,主治医师,副主任医师,主任医师".split(',')
    this.$http({
