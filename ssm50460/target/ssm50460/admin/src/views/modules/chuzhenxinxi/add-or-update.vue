<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出诊时间" prop="chuzhenshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuzhenshijian" label="出诊时间" prop="chuzhenshijian">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="可约人数" prop="keyuerenshu">
          <el-input v-model="ruleForm.keyuerenshu" 
              placeholder="可约人数" clearable  :readonly="ro.keyuerenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="可约人数" prop="keyuerenshu">
              <el-input v-model="ruleForm.keyuerenshu" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.shanzhang!=''&&json.shanzhang){
              		this.ruleForm.shanzhang = json.shanzhang
		}
        } else {
